...
Read 2026-09-14 out of `Z:/ServerSource/Zone00/Zone.exe` + `Zone.pdb` (capstone; `common/tools/xref_range.py` for the
...
`"width": 1` (also 2), added for these recipes. `common/tools/xref_range.py` is the reference scanner.
