"""Generate recipes/void-bag-reloc.json - the 17 original jump-table entries are READ from the exe."""
import json
import struct
...
json.dump(recipe, open('C:/Projects/ik-fiesta-patch-recipes/recipes/void-bag-reloc.json', 'w', newline='\n'),
          indent=2)
