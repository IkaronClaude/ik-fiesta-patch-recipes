"""Generate recipes/npc-table-cap.json: lift NPCManager's fixed 1024-row table.

    python tools/mk_npc_table_cap.py --exe Z:/ServerSource/Zone00/Zone.exe
...
def main():
    ...
    recipe = {
        ...
        'why': [
            ...
            'stock exe (tools/mk_npc_table_cap.py - rerun it to reproduce this file):',
            '',
