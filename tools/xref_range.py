...
register-relative offsets), grouped by the containing function.
    ...
    python tools/xref_range.py --range 0x8B7018-0x8B7418            # absolute references into a static object
    python tools/xref_range.py --disp 0x28068-0x28098                # [reg + disp32] member offsets (mid-object array)
    python tools/xref_range.py --range ... --exe Z:/ServerSource/Zone00/Zone.exe --pdb Z:/ServerSource/Zone00/Zone.pdb
